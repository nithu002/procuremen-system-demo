    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-6">
                    <h3 class="card-title">New Quotation list</h3>
        ...
        <div class="card-body">
          <table id="example2" class="table table-bordered table-hover data-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="quotation/{{$filterRequests->id }}">{{ $filterRequests->reqno }}</a></td>

                    <td>{{ $filterRequests->supervisor_name  }} </td>

                    <td>{{ $filterRequests->budget }}</td>

                    <td>{{ $filterRequests->need_date }}</td>

                    <td class="project-state"><span class="badge badge-info blink_me"><b>New Request</b></span></td>


                    <td><a class="btn btn-primary btn-sm" href="quotation/{{$filterRequests->id }}"> <i class="nav-icon fas fa-plus"></i>&nbsp;Attach the file</a>
