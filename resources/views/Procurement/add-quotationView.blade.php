                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- /.col -->
                                                <div class="col-4">
                                                  <p class="lead">Need by <b style="color:red">{{ $details->need_date }}</b></p>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <b style="text-align: center">:- {{ $details->super_vioser_remarks }}</b>
                                                </div>
                                            </div>
                                                        ...
                                                        <tbody>
                                                            <tr data-widget="expandable-table" aria-expanded="false">
                                                                <td>
                                                                    ...
                                                                    <b style="color:#007bff;">Link the quotation details below</b>
                                                                </td>
                                                            </tr>
                                                            <tr class="expandable-body">
                                                            <td>
                                                                <table class="table table-hover">
                                                                    <form action="{{ url('procurementPanel/quotation/details/update') }}" method="POST" enctype="multipart/form-data">
                                                                        <tbody>
                                                                            @csrf
                                                                            <br>
