...
@section('sub-heading')
   ...
   <div class="col-sm-6">
      <h1 class="m-0">Purchase Order Form</h1>
   </div>
   <div class="col-sm-6">
        ...
        <div class="col-xl-12">
            ...
            <section class="content card-default">
                <div class="container-fluid">
                    <form  action="{{ url('procurementPanel/insert') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-sm-9 invoice-col">
                                            ...
                                            <b>PR Generator:</b> <b class="lead">{{ $staff }}</b> <br><br>
                                        </div>
                                        <!-- /.col -->
