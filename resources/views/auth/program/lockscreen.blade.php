                            ...
                            <div class="card bg-transparent shadow-none border-0">
                                <div class="card-body">
                                    <div class="py-3 text-center">
                                        ...
                                        <form method="POST" action="{{ url('program/lockscreen') }}">
                                            @csrf
                                            @if (Session::has('fail'))
                                            ...
                                            <div class="mt-4 text-center">
                                                <p class="text-muted mb-0">Not you {{ $data->name }} ? return  <a href="{{ url('/programlock') }}" class="fw-semibold text-decoration-underline"> Login </a> </p>
                                            </div>
                                        </form>
                                    </div>
                                </div>
