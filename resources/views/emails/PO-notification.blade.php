                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Your purchase quotation has been approved by supervisor. We would like you to prepare a Purchase Order for purchase requisition related to {{ $details['id'] }}.
                                        </p>

                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Purchase order No#: {{ $details['POID'] }}
.
                                        </p>
