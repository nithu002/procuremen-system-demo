                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h2
                                            ...
                                            Hello  {{ $details['procurmer'] }},</h2>
                                            <br>

                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Your purchase order has been denied by Operation Lead. We would like you to re-prepare a purchase order for purchase requisition related to   {{ $details['prID'] }}


                                        </p>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Purchase order No:{{ $details['id'] }}.
                                        </p>

                                        <p style="color:#455056; text-align: center;">You may review it through this link  below
                                        </p>


                                        <p><a href="{{ url('/procurementPanel') }}"
