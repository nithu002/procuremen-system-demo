                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h2
                                            ...
                                            Hello  {{ $details['name'] }},</h2>
                                            <br>

                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            The Procument Request #PR-0530-083 has been supported by {{ $details['procumer'] }} with quotations and supportive documents which waiting for your endorsement
                                        </p>
