    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href={{ url('financial/profile') }} class="nav-link active">
...
@section('sub-heading')
   ...
   <div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="financial/dashboard">Home</a></li>
                                        ...
                                        <tr class="expandable-body">
                                            <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>
                                                        <table class="table table-hover">
                                                            <form action="{{ url('financial/profile/password') }}" method="POST">
                                                                <tbody>
                                                                    <div class="row">
...
<script>
    ...
    $('.editable1').editable({
        url:'{{ url('financial/profile/update') }}',
        type:'text',
        pk:1,
        name:'name',
        title:'Enter name',
    ...
    $('.editable2').editable({
        url:'{{ url('financial/profile/update/any') }}',
        type:'email',
        pk:1,
        name:'email',
        title:'Enter email',
