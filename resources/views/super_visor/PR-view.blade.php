                                ...
                                <div class="container-fluid">
                                    <div class="card col-xl-12">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <a href="{{ url('viocer/all') }}" class="btn btn-primary reload float-right mb-3"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                                                        Back</a>
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                  <h4>
                                                    <i class="fa fa-broken" ></i>&nbsp;Purchase Requestion
                                                ...
                                                <tr class="expandable-body">
                                                    <td>
                                                        ...
                                                        <tbody>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-sm-12 invoice-col">
                                                                                               <label><strong>Remarks</strong></label><br>
                                                                                                <textarea name="remarks" id="remarks" cols="90" rows="4" disabled>{{ $details->super_vioser_remarks }}</textarea>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row">
                                                                    ...
                                                                    @elseif($details->status_now == 'Quo_Approved')
                                                                        <tr class="print" data-widget="expandable-table" aria-expanded="false">
                                                                            <td>
                                                                                <button type="button" class="btn btn-primary p-0">
                                                                                <i class="expandable-table-caret fas fa-caret-right fa-fw"></i>
                                                                                ...
                                                                                <table class="table table-hover">
                                                                                    <tbody>
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-4 invoice-col">
                                                                                                <b>Quotation Status :</b> {{ $details->status_now }}<br>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row">
                                                                                            <div class="col-sm-4 invoice-col">
                                                                                                <label class="vecfrm link-black">Selected Quotation files</label> <br>
                                                                                                    <p>
                                                                                                        <a href="download7/{{ $details->id }}" target="new" class="link-black text-sm"><i class="fas fa-link mr-1"></i>Quotation 1 {{ $details->seleded_quotation }}</a>
                                                                                                    </p>
                                                                                            </div>
                                                                                            <div class="col-sm-8 invoice-col">
                                                                                              <label><strong>Remarks</strong></label><br>
                                                                                               <textarea name="remarks" id="remarks" cols="50" rows="4" disabled>{{ $details->super_vioser_remarks }}</textarea>
                                                                                            </div>
                                                                    ...
                                                                    @else
                                                                            ...
                                                                            <tr class="expandable-body">
                                                                                <td>
                                                                                    ...
                                                                                    <table class="table table-hover">
                                                                                        <tbody>
                                                                                            <form action="{{ url('viocer/details/report/update') }}" method="POST" enctype="multipart/form-data">
                                                                                                    @csrf
                                                                                                    <div class="row">
                                                                                                        <div class="col-sm-6 invoice-col">
                                                                                                            <div hidden>
                                                                                                                <input  name="user_email" value="{{ $details->email }}"/> <input  name="id" value="{{ $details->id }}" />
                                                                                                            </div>
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <div class="col-6 col-sm-6">
                                                                                                            <div class="form-group">
                                                                                                                <label><strong>Choose PR Status :</strong></label>
                                                                                                                    <select class="form-control " id="status" onchange="enableBrand(this)" name="status" required>
                                                                                                                        @if($details->procument_name)
                                                                                                                           <option  value="PR_Approved" selected disabled >Approved</option>
                                                                                                                        @else
                                                                                                                           <option  value="PR_Rejected" selected disabled >Rejected</option>
                                                                                                                        @endif
                                                                                                                ...
                                                                                                                <div class="form-group">
                                                                                                                    <label><strong>Choose Procurement Officer:</strong></label>
                                                                                                                        <select class="form-control "  id='procument_name' name="procument_name" required>
                                                                                                                            <option  selected disabled>{{ $details->procument_name }}</option>
                                                                                                         ...
                                                                                                         @else
                                                                                                            <div class="col-6 col-sm-6 ">
                                                                                                                <div class="form-group d-none" id="officer" >
                                                                                                                    <label><strong>Choose Procurement Officer:</strong></label>
                                                                                                                        <select class="form-control "  id='procument_name' name="procument_name" required>
                                                                                                                            <option  selected disabled>Choose Procurement Officer</option>
                                                                                                                                @foreach ($procument as $name )
                                                                                                                            <option  value="{{ $name->name }}">{{ $name->name }}</option>
                                                                                                                                @endforeach
                                                                                                                        </select>
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <div class="col-12 col-sm-8">
                                                                                                            <div class="form-group">
                                                                                                                <label><strong>Remarks</strong></label><br>
                                                                                                                    <textarea name="remarks" id="remarks" cols="90" rows="4">{{ $details->super_vioser_remarks }}</textarea>
                                                                                                            </div>
                                                                                                        </div>
                                                                                    ...
                                                                                    <table class="table table-hover">
                                                                                        <tbody>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-sm-4 invoice-col">
                                                                                                  <b>Single Source :</b> {{ $details->single_source }}<br>
                                                                                                  <input hidden  value="{{ $details->id }}" name="id"/>
                                                                                                </div>
                                                                                                <div class="col-sm-4 invoice-col">
                                                                                                    <textarea name="single_sourceText" id="single_sourceText" cols="30" rows="3" disabled>{{ $details->single_sourceText }}</textarea><br>
                                                                                                    <div id="textHelp" class="text-black-50">Single Source – Justification</div>
                                                                                                ...
                                                                                                <div class="col-sm-4 invoice-col">
                                                                                                    <div class="form-group" >
                                                                                                        ...
                                                                                                        <select class="form-control "  id='procument_name' name="status" required>
                                                                                                                <option  selected disabled>{{ $details->status_now }}</option>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-sm-4 invoice-col">
                                                                                                    <div class="form-group">
                                                                                                            ...
                                                                                                            <input type="file" class="link-black text-sm" id="file_tor" name="file_tor" accept=".pdf, .docx">
                                                                                                            <div id="textHelp" class="text-black-50">Selected quotation files name :{{ $details->seleded_quotation }}</div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-sm-8 invoice-col">
                                                                                                <label><strong>Remarks</strong></label><br>
                                                                                                <textarea name="remarks" id="remarks" cols="50" rows="4" >{{ $details->super_vioser_remarks }}</textarea>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-3 invoice-col ">
                                                                                                    <button type="submit" id="button" class="btn btn-primary float-right" >Update Approval </button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </form>
