        ...
        <div class="card-body">
          <table id="example2" class="table table-bordered table-hover data-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="{{ url("viocer/new/quotation/$filterRequests->id ") }}">{{ $filterRequests->reqno }}</a></td>
                    ...
                    <td><a class="btn btn-primary btn-sm" href="{{ url("viocer/new/quotation/$filterRequests->id ") }}"> <i class="nav-icon fas fa-eye"></i> &nbsp; View</a>
