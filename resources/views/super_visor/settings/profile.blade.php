    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href={{ url('viocer/profile') }} class="nav-link active">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ url('viocer/profile/delete') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="card-body box-profile">
                                ...
                                <div class="text-center">
                                    ...
                                    <input hidden name="id" value="{{ $data->id }}">
                                     <div class="photo-img" id="image_user"
                                      style="background-image:asset('/storage/{{ $data->user_img }}');">
                                     </div>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                              <li class="list-group-item">
                                <b>PR Approved</b> <a class="float-right">{{ $accepted }}</a>
                              </li>
                              <li class="list-group-item">
                                <b style="color:red;">PR Rejected</b> <a  style="color:red;" class="float-right">{{ $rejected }}</a>
                              </li>
                              <li class="list-group-item">
                                <b  style="color:green;">Allocated Staffs</b> <a  style="color:green;" class="float-right">{{ $staffcont }}</a>
                              </li>
                            </ul>
                                        ...
                                        <tr class="expandable-body">
                                            <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>
                                                        <table class="table table-hover">
                                                            <form action="{{ url('viocer/profile/password') }}" method="POST">
                                                                <tbody>
                                                                    <div class="row">
...
<script>
    ...
    $('.editable2').editable({
        url:'{{ url('viocer/profile/update/any') }}',
        type:'email',
        pk:1,
        name:'email',
        title:'Enter email',
